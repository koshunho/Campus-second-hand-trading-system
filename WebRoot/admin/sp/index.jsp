...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
    ...
    <%		cb.setEVERYPAGENUM(12);
			...
			List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from sp  order by id desc",8);
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath%>ComServlet?method=delsp2&id=<%=pagelist2.get(0).toString()%>" >删除</a></td>
    </tr>
