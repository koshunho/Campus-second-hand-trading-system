  ...
  <TR>
	...
	<form action="<%=basePath %>Member.do?method=UPREGINFO" method="post" name="regform" onSubmit="return checkpersonreg()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  ...
		  <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >班&nbsp;&nbsp;&nbsp;&nbsp;级：</TD>
			<TD width="70%" align="left" id=map>
			<INPUT class=inputb maxLength=24 size=30 name=sex value=<%=list.get(2).toString() %>> <FONT color=#ff0000>**</FONT>
			</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
			<TD width="30%" align="right" >学&nbsp;&nbsp;&nbsp;&nbsp;号：</TD>
			<TD width="70%" align="left" id=map>
			<INPUT class=inputb maxLength=24 size=30 name=bir value=<%=list.get(3).toString() %>> <FONT color=#ff0000>**</FONT>
			</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
