...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
     <tr class="head"> 
      ...
      <td  align="center">交货时间</td>
      <td  align="center">交货地点</td>
      <td  align="center">卖家</td>
      <td  align="center">删除</td> 
    </tr>
    <%
    		cb.setEVERYPAGENUM(12);
			int cou = cb.getMessageCount("select count(*) from prep where str='"+member+"' and flag='已经提交'");//得到信息总数			        
			...
			List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from prep where str='"+member+"' and flag='已经提交' order by id desc",9);
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>ComServlet?method=delpabc&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
     </tr>
