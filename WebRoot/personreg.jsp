...
%>
            ...
            <TABLE  height=75 cellSpacing=0 cellPadding=0 width=950 align=center  border=0>
              <TBODY>
              ...
              <TR>
                ...
                <FORM id="regform" name="regform" action="<%=basePath%>Member.do?method=PREG" method="post">
                  <TABLE cellSpacing=0 cellPadding=0 width=950 bgColor=#f5f5f5 border=0>
         ...
         <TABLE  height=237 cellSpacing=0  cellPadding=0 width="100%" border=0 hspace="12">
                          ...
                          <TR >
                            <TD vAlign=center align=right  height=26>&nbsp;&nbsp;班&nbsp;&nbsp;&nbsp;&nbsp;级：</TD>
                            <TD width=556 height=26 align=left>
							<INPUT class=inputb maxLength=24 size=30 name=sex> <FONT color=#ff0000>**</FONT> </TD></TR>
						  <TR >
						    <TD vAlign=center align=right  height=26>&nbsp;&nbsp;学&nbsp;&nbsp;&nbsp;&nbsp;号：</TD>
						    <TD width=556 height=26 align=left>
						    <INPUT class=inputb maxLength=24 size=30 name=bir> <FONT color=#ff0000>**</FONT> </TD></TR>
                          <TR >
