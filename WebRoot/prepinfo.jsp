...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		<form action="<%=basePath %>ComServlet?method=addprep" method="post" name="form1" >
         <TABLE   cellSpacing=0 cellPadding=0 width="100%" border=0>
         <TBODY>
                    
        <TR>
          <TD width=45% align=right>商品名称：</TD><TD align=left><%=Common.toChineseAndTrim(request.getParameter("title")) %></TD>
		</TR>
		 
		<TR>
          <TD  align=right>购买数量：<input type=hidden name=spid value=<%=request.getParameter("spid")%>></TD>
