...
<TABLE class=MainTable cellSpacing=0 cellPadding=0 width="950" align=center 
border=0>
<TR>
<TD>
<TABLE class=dragTable id=viewarticle cellSpacing=0 cellPadding=0 width="950" align=center border=0>
  <TBODY>
  <TR>
    <TD class=head>
            <H3 class=L></H3><FONT 
      ...
      <DIV align=center>
      <TABLE class=dragTable  cellSpacing=0 cellPadding=0 width="950" align=center border=0>
        <TBODY>
        <TR>
