...
function f1()
{
 if(document.form1.title.value==""&&document.form1.type.value==""&&document.form1.time.value=="")
 {
 	alert("请至少输入一个查询选项！");
...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
		...
		<TR>
          <TD  align=center>商品名称： <input type=text name=title size=30 > <input type=button onclick="f1()" value="查询信息"></TD>
		</TR>
				</TBODY>
			</TABLE>
			</form>			
