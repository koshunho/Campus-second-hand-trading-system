...
//			String str=new ComBean().getString("select member from sp where id='"+sid+"'");
...
//		}
		...
		////////////////////////////////////////////////////////////////////////////////////生成订单
			...
			if(check == null){
				...
				String flag = tb.scdDan(id2,member); 
				if(flag !=null){
					//request.setAttribute("message", "订单已成功提交，请等候发货！");
					request.setAttribute("flag", flag);
					request.getRequestDispatcher("member/prep/up.jsp").forward(request, response);
				}
				else{
					request.setAttribute("message", "系统维护中，请稍后再试！");
					request.getRequestDispatcher("member/prep/index.jsp").forward(request, response);
