...
public class HzpBean {
	...
	public int hotTrave(String id){
		String sql="update sale set flag='畅销商品' where id='"+id+"'";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int i = dbo.executeUpdate(sql);
	...
	public int nohotTrave(String id){
		String sql="update sale set flag='普通商品' where id='"+id+"'";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int i = dbo.executeUpdate(sql);
	...
	public List getAllTeJiaTrave(){
		String sql = "select * from sale where flag='特价商品' order by id desc";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
	...
	public List getAllTuiJianTrave(){
		String sql = "select * from sale where flag='推荐商品' order by id desc";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
	...
	public List get10HotTrave(){
		String sql = "select   * from sale where flag='畅销商品' order by id desc  limit 0,5 ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
	...
	public int addPrep(String sid,int num,String member,String str){
		String sql = "insert into prep (sid,num,member,flag,str) values ('"+sid+"','"+num+"','"+member+"','未提交订单','"+str+"')";
		DBO dbo = new DBO();
		dbo.open();
		try{
	...
	public List getMemberPrep(String member){
		String sql = "select sp.id,sp.mc,sp.jg,prep.*,sale.sl from sale,prep where sale.id=prep.sid and prep.member='"+member+"' and prep.flag='未提交订单' order by prep.id desc";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
	...
	/////////////////////////////////////////////////////////会员提交订单
	public String scdDan(int id[],String member){
		DBO dbo = new DBO();
		dbo.open();
		String d=this.date;
		...
		try{
			...
			dbo.executeUpdate("insert into post(dnum,addtime,flag,member) values('"+dnum+"','"+d+"','未发货','"+member+"')");
			return dnum;
		}catch(Exception e){
			e.printStackTrace();
			return null;
